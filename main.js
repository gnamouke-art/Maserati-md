...
global.channelLink = "https://www.youtube.com";
global.ytch = "Yankee Tech";
        ...
        if (message.message?.buttonsResponseMessage) {
            ...
            if (buttonId === 'channel') {
                await sock.sendMessage(chatId, {
                    text: '📢 *Join our Channel:*\nhttps://whatsapp.com/channel/0029Vb7xYNO84OmK7L02eq3v'
                }, { quoted: message });
                return;
                ...
                await sock.sendMessage(chatId, {
                    text: `🔗 *Support*\n\nhttps://chat.whatsapp.com/LRhRIn8e7VoIXhtZRf70xx?mode=gi_t`
                }, { quoted: message });
                return;
            }
        }
