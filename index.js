...
let phoneNumber = "2250585256740"
let owner = JSON.parse(fs.readFileSync('./data/owner.json'))

global.botname = "MASERATI-MD"
global.themeemoji = "•"
...
async function startXeonBotInc() {
    ...
    XeonBotInc.ev.on('connection.update', async (s) => {
        ...
        if (connection == "open") {
            ...
            await delay(1999)
            console.log(chalk.yellow(`\n\n                  ${chalk.bold.blue(`[ ${global.botname || 'MASERATI-MD'} ]`)}\n\n`))
            console.log(chalk.cyan(`< ================================================== >`))
            console.log(chalk.magenta(`\n${global.themeemoji || '•'} YT CHANNEL:YANKEETech`))
            console.log(chalk.magenta(`${global.themeemoji || '•'} GITHUB: YANKEEtech`))
